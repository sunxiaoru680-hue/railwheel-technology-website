...
for (const blog of blogs) {
  ...
  addPage(`news/${blog.slug}/index.html`, layout({
    title: isAxleGuide ? "Railway Axle Supplier Procurement Guide | Railwheel" : `${blog.title} | Railway Wheel Supplier Insights`,
    description: isAxleGuide ? "Choose a railway axle supplier with this buyer guide to drawings, standards, material, inspection documents, packing and RFQ preparation." : `${blog.summary} Includes railway wheel, train wheel, railroad wheel and railway components procurement guidance.`,
    path: `/news/${blog.slug}/`,
    active: "News",
