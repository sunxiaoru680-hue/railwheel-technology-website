...
for (const blog of blogs) {
  ...
  addPage(`news/${blog.slug}/index.html`, layout({
    title: isRfqChecklist ? "Railway Wheel & Wheelset RFQ Checklist | Railwheel" : `${blog.title} | Railway Wheel Supplier Insights`,
    description: isRfqChecklist ? "Railway wheel and wheelset RFQ checklist covering drawings, material, EN and AAR standards, inspection, traceability and supplier evaluation." : `${blog.summary} Includes railway wheel, train wheel, railroad wheel and railway components procurement guidance.`,
    path: `/news/${blog.slug}/`,
    active: "News",
